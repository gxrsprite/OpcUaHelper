...
namespace OpcUaHelper
{
    ...
    public class OpcUaClient
    {
        ...
        /// <summary>
        /// 删除多个节点的操作，除非服务器配置允许，否则引发异常，成功返回<c>True</c>，否则返回<c>False</c>
        /// </summary>
        /// <param name="tags">节点文本描述</param>
        /// <returns>是否删除成功</returns>
        public bool DeleteExsistNode(List<string> tags)
        {
            DeleteNodesItemCollection waitDelete = new DeleteNodesItemCollection();
